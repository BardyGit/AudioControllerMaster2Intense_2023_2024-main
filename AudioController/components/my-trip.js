export class MyTrip extends HTMLElement {
  constructor() {
    super();
  }
  ...
  connectedCallback() {
    ...
    var audio = this.getAudioPlayer().audioElm;
    ...
    function startVis() {
        ...
        function render() {
            ...
            ball.rotation.x += 0.001 * 3;
            ball.rotation.y += 0.005 * 3;
            ball.rotation.z += 0.002 * 3;
...
customElements.define('my-trip', MyTrip);
